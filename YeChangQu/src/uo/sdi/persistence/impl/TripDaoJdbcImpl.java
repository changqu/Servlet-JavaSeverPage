...
public class TripDaoJdbcImpl implements TripDao {
	...
	@Override
	public List<Trip> ordenacionByOrigen() {
		return jdbcTemplate.queryForList("TRIP_ORDENACION_BY_ORIGEN", new TripMapper());
	}

	@Override
	public List<Trip> ordenacionByDestino() {
		return jdbcTemplate.queryForList("TRIP_ORDENACION_BY_DESTINO", new TripMapper());
	}

	@Override
	public List<Trip> ordenacionByFecha() {
		return jdbcTemplate.queryForList("TRIP_ORDENACION_BY_FECHA", new TripMapper());
	}

	@Override
	public List<Trip> ordenacionByPromotor() {
		return jdbcTemplate.queryForList("TRIP_ORDENACION_BY_PROMOTOR", new TripMapper());
	}

	@Override
	public List<Trip> findOpen() {
		return jdbcTemplate.queryForList("TRIP_FIND_OPEN", new TripMapper());
	}

	@Override
	public List<Trip> findDone() {
		return jdbcTemplate.queryForList("TRIP_FIND_DONE", new TripMapper());
	}

	@Override
	public List<Trip> findNoDoneByPromoter(Long id) {
		return jdbcTemplate.queryForList("TRIP_FIND_NODONE_AND_BY_PROMOTER", 
				new TripMapper(), id);
	}
